...
function contactPage() {
  ...
  document.write(submitButtonClick);
...
function productPage() {
  ...
  var currentLink = document.getElementById("productsLink");
  document.write(currentLink);
  ...
  document.getElementById("productsLink").innerHTML = content;
