...
function productPage() {
  ...
  document.body.style.backgroundImage = "url('images/dc logo.jpg')";
    var paragraph1=document.getElementById("paragraph1");
      paragraph1.innerHTML = "This was one of our first programming assignments in this Durham College Program"+
        " and this was one of the first assignments that we both really enjoyed building with"+
        " in the Python Programming Language."

    var paragraph2= document.getElementById("paragraph2");
      paragraph2.innerHTML = "This was one assignment that we had to do for our Systems"+
    ...
    var paragraph3 = document.getElementById("paragraph3");
      paragraph3.innerHTML ="This was our Linux assignment where we had to use packet managers"+
...
function servicePage() {
  ...
  humanResourcesLink.innerHTML =
    ...
    paragraph4.innerHTML = "One of the services that we provide is custom programming for any project:"+          
    ...
    paragraph5.innerHTML = "Mobile Development is another one of our services that we provide" +
        "because many of our clients need mobile applications for their " +
        "business needs."
    var paragraph6 = document.getElementById("paragraph6");
    paragraph6.innerHTML = "Web-Development is another one of our major services that we provide"+
...
function aboutPage() {
  ...
  humanResourcesLink.innerHTML =
   ...
   document.body.style.backgroundImage = "url('images/dc logo.jpg')";
      ...
      heading1.innerHTML = "This is a picture of Angaran. Angaran is a 2nd year student in the Computer Programmer Analyst Program" +
